...
// ISPD_OPTIC.exe
  PROGRAM_VER      = 'R1.00';
  PROGRAM_NAME     = 'Inspector IT_OLED TLS';
  ...
  MAX_CA410_CAL_ITEM      = 4; // White, R, G, B
...
//  MSG_TYPE_LOGIC  = 3;
  ...
  MSG_MODE_CA410_STATUS           = 44;
  MSG_MODE_CA410_NG               = 45;
